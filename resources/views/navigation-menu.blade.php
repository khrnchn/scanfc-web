        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        @can('view-any', App\Models\Attendance::class)
                        ...
                        @endcan
                        @can('view-any', App\Models\Lecturer::class)
                        <x-dropdown-link href="{{ route('lecturers.index') }}">
                        Lecturers
                        </x-dropdown-link>
                        @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @can('view-any', App\Models\Attendance::class)
                <x-jet-responsive-nav-link href="{{ route('attendances.index') }}">
                Attendances
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Classroom::class)
                <x-jet-responsive-nav-link href="{{ route('classrooms.index') }}">
                Classes
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Faculty::class)
                <x-jet-responsive-nav-link href="{{ route('faculties.index') }}">
                Faculties
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Lecturer::class)
                <x-jet-responsive-nav-link href="{{ route('lecturers.index') }}">
                Lecturers
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\User::class)
                ...
                @endcan
                @can('view-any', App\Models\Subject::class)
                <x-jet-responsive-nav-link href="{{ route('subjects.index') }}">
                Subjects
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Student::class)
